      ...
      try {
        ...
        try {
          ...
          if (apiRes.ok) {
            ...
            console.log("GolfCourseAPI raw response:", JSON.stringify(apiData).slice(0, 500));
            // API may return { courses: [] }, { data: [] }, or a bare array
            ...
            const apiCourses = rawCourses
              ...
              .map((c, ci) => {
                // tees can be an array OR a keyed object — normalize to array
